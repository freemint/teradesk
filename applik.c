...
_WORD trash_or_print(ITMTYPE type);	/* from ICON.C */
...
static void appinfo_info
( 
	LSTYPE **llist,	/* list of installed apps */ 
...
static bool app_dialog
(
	LSTYPE **llist, 	/* list to check for duplicates in */
