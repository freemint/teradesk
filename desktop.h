...
#define MICONIF          52  /* STRING in tree MENU */
#define MFULL            53  /* STRING in tree MENU */
#define MCLOSE           54  /* STRING in tree MENU */
#define MCLOSEW          55  /* STRING in tree MENU */
#define MCLOSALL         56  /* STRING in tree MENU */
#define MDUPLIC          57  /* STRING in tree MENU */
#define MCYCLE           58  /* STRING in tree MENU */
#define MNOPTBOX         59  /* BOX in tree MENU */
#define MAPPLIK          60  /* STRING in tree MENU */
#define MPRGOPT          61  /* STRING in tree MENU */
#define SEP7             62  /* STRING in tree MENU */
#define MIDSKICN         63  /* STRING in tree MENU */
#define MIWDICN          64  /* STRING in tree MENU */
#define SEP8             65  /* STRING in tree MENU */
#define MOPTIONS         66  /* STRING in tree MENU */
#define MCOPTS           67  /* STRING in tree MENU */
#define MWDOPT           68  /* STRING in tree MENU */
#define MVOPTS           69  /* STRING in tree MENU */
#define SEP9             70  /* STRING in tree MENU */
#define MLOADOPT         71  /* STRING in tree MENU */
#define MSAVESET         72  /* STRING in tree MENU */
#define MSAVEAS          73  /* STRING in tree MENU */
